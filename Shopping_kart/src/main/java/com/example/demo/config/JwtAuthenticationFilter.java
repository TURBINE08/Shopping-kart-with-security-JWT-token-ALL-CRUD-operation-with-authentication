		...
		if(requestToken!= null && requestToken.startsWith("Bearer "))
		{
			...
			if(username!= null && SecurityContextHolder.getContext().getAuthentication()==null)
			{
				...
				if(this.jwtTokenHelper.validateToken(token, userDetails))
				{
					...
					SecurityContextHolder.getContext().setAuthentication(usernamePasswordAuthenticationToken); // set the authentication by using predefine method
																										       // by using authentication object to get authentication object we use
																											   //predefine class UsernamePasswordAuthenticationToken above
				}
				else
				{
